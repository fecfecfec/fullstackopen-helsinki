  ...
  const addNewContact = (event) => {
    ...
    if (nameExists) {
        ...
        contactsService
          ...
          .then(() => {
            ...
            setConfirmationMessage(
              <>
                You have updated <strong>{newName}</strong> phone number
              </>
            )
            setTimeout(() => {
      ...
      contactsService.create(newContact).then((returnedContact) => {
        ...
        setConfirmationMessage(
          <>
            You have added <strong>{newContact.name}</strong> to your contacts.
          </>
        )
        setTimeout(() => {
          setConfirmationMessage(null)
    ...
    if (confirmDelete) {
      contactsService
        ...
        .then(() => {
          setConfirmationMessage(
            <>
              You have deleted <strong>{targetContact.name}</strong> from your
              contacts.
            </>
          )
          setTimeout(() => {
